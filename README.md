...
|  | [`operation-body`](https://github.com/gregswindle/eslint-plugin-swagger-tools/issues/new?title=feat%28operation-body%29%3A%20Each%20operation%20should%20have%20...&labels[]=ESLint%3A%20Rule&labels[]=Status%3A%20Available&labels[]=Type%3A%20Feature&labels[]=Type%3A%20Docs) | Each operation should have only one parameter of type `body`  | Available |
